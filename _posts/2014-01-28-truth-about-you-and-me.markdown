...
<object data="{{ site.baseurl }}/assets/img/SVG/portfolio-10.svg" type="image/svg+xml" class="truth-img"></object>
...
<object data="{{ site.baseurl }}/assets/img/SVG/portfolio-11.svg" type="image/svg+xml" class="truth-img"></object>
