...
<div id="container">
    ...
    <div id="content">
        ...
        <div id="mailform"><input type="text" value="me@website.com" id="from" /><input type="button" id="submit-button" value="Request Press Copy" /><br/>&nbsp;<br/>
		-->
		To request a press copy, please <a href="#contact">send us a quick email</a>. We will get bacck to you as soon as a press copy is available.</div>
